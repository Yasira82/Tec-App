    ...
    <main className={styles.main} dir={dir}>
      ...
      <header className={styles.header}>
        ...
        <div className={styles.headerCenter}>
          <span className={styles.headerIcon}><Icon name="spark" size={24} color="#F8B820" strokeWidth={1.8} /></span>
          <div>
          ...
          <div className={styles.messagesWrap}>
            <div className={styles.messages} role="log" aria-live="polite" aria-relevant="additions text">
              {messages.map(msg => (
                ...
                >
                  {msg.role === 'assistant' && (
                    <span className={styles.messageAvatar}><Icon name="spark" size={20} color="#F8B820" strokeWidth={1.8} /></span>
                  )}
