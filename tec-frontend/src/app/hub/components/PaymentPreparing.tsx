...
export function PaymentPreparing() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--tec-bg)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 16 }}>
      ...
      <div style={{ width: 64, height: 64, borderRadius: 20, background: 'var(--tec-gold)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 28, fontWeight: 900, color: 'var(--tec-on-gold)' }}>T</div>
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        <div style={{ width: 20, height: 20, borderRadius: '50%', border: '2px solid rgba(var(--tec-gold-rgb),0.2)', borderTopColor: 'var(--tec-gold)', animation: 'spin 0.8s linear infinite' }} />
