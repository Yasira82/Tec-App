...
function HubPayRedirectInner() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--tec-bg)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ width: 32, height: 32, borderRadius: '50%', border: '2px solid rgba(var(--tec-gold-rgb),0.15)', borderTopColor: 'var(--tec-gold)', animation: 'spin 0.8s linear infinite' }} />
