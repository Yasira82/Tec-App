...
const S: Record<string, React.CSSProperties> = {
  ...
  tabOn: { background: '#F8B82014', borderColor: '#F8B82040', color: 'var(--tec-gold)', fontWeight: 600 },
  ...
  starter: { textAlign: 'start', padding: '10px 12px', borderRadius: 12, cursor: 'pointer',
             border: '1px solid #F8B82030', background: '#F8B8200A', color: 'var(--tec-gold)',
  ...
  optOn: { background: '#F8B82014', borderColor: '#F8B82040', color: 'var(--tec-gold)', fontWeight: 600 },
  ...
  star:  { background: 'none', border: 'none', cursor: 'pointer', fontSize: 22,
           color: '#F8B82033', padding: 2, lineHeight: 1 },
