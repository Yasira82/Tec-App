  ...
  return (
    <aside
              ...
              return (
                <Link key={item.href} href={item.href} className="tec-nav-link"
                  ...
                  style={{
                    ...
                    textDecoration: 'none',
                    background: active ? 'rgba(var(--tec-gold-rgb),0.1)' : 'transparent',
                    border: `1px solid ${active ? 'rgba(var(--tec-gold-rgb),0.2)' : 'transparent'}`,
      ...
      <div style={{ padding: 'var(--sp-3)', borderTop: '1px solid var(--tec-fill-soft)' }}>
        ...
        {!isStandalone && (
          <button onClick={onInstall} className="tec-btn"
            style={{
              ...
              background: 'transparent', border: '1px solid rgba(var(--tec-gold-rgb),0.18)',
        ...
        {installSteps && (
          <div style={{ padding: '10px', marginBottom: 6, borderRadius: 'var(--radius-md)', background: 'rgba(var(--tec-gold-rgb),0.06)', border: '1px solid rgba(var(--tec-gold-rgb),0.12)' }}>
            {[t.home.install.step1, t.home.install.step2, t.home.install.step3].map((step, i) => (
              <div key={i} style={{ display: 'flex', gap: 8, alignItems: 'flex-start', margin: '4px 0' }}>
                <span style={{ flexShrink: 0, width: 16, height: 16, borderRadius: 999, background: 'rgba(var(--tec-gold-rgb),0.16)', color: 'var(--tec-gold)', fontSize: 9, fontWeight: 700, display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>{i + 1}</span>
            ...
            <button onClick={onCopy} className="tec-btn"
              style={{ width: '100%', marginTop: 6, padding: '7px 10px', borderRadius: 8, border: '1px solid rgba(var(--tec-gold-rgb),0.3)', background: 'rgba(var(--tec-gold-rgb),0.1)', color: 'var(--tec-gold)', fontSize: 11, fontWeight: 700, cursor: 'pointer' }}>
