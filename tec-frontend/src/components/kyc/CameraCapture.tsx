            ...
            <div style={{ textAlign: 'center', maxWidth: 380 }}>
              ...
              <div style={{ display: 'flex', gap: 'var(--sp-3)', justifyContent: 'center' }}>
                ...
                <label htmlFor={inputId}
                  style={{ padding: '11px 20px', borderRadius: 'var(--radius-md)', background: 'var(--tec-gold)', border: 'none', color: '#1a1200', fontWeight: 700, fontSize: 'var(--text-sm)', cursor: 'pointer' }}>
                  Use phone camera
                </label>
              </div>
            </div>
